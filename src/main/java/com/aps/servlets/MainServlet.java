	       ...
	       response.setBufferSize(8192);
                     ...
                     switch (Integer.parseInt(request.getParameter("case")))
                     {
                          ...
                          case 2 : if (Validate.isPlaceExists(request.getParameter("plcdesc")))
			    	         ...
			    	         // + "<a href=\"http://"+ipadd+":8090/EBwn2/place_entry.html\"><input type=\"button\" value=\"Return\"></a>"
			    	          ...
			    	          //+ "<a href=\"http://"+ipadd+":8090/EBwn2/successlogin.html\"><input type=\"button\" value=\"Return\"></a>"
			    	          + "<form id=\"form80\" method=\"POST\" action=\"SchUtil\">"
                          ...
                          case 3 : String rid=Validate.isRatingExists(Fetch.getUserFromId(request.getParameter("uid")),request.getParameter("placeid"));
                                   if (rid!=null)
                                   {
			    	                   ...
			    	                   //+ "<a href=\"http://"+ipadd+":8090/EBwn2/entryreview.html\"><input type=\"button\" value=\"Return\"></a>"
			    	                   + "<form id=\"form80\" method=\"POST\" action=\"SchUtil\">"
	       ...
	       response.setBufferSize(8192);
                     ...
                     switch (Integer.parseInt(request.getParameter("case")))
                     {
                         ...
                         default : if (request.getParameterMap().containsKey("emailid"))
			    	          ...
			    	          //+ "<a href=\"http://"+ipadd+":8090/EBwn2/updateemail.html\"><input type=\"button\" value=\"Return\"></a>"
			    	          + "<form id=\"form80\" method=\"POST\" action=\"SchUtil\">"
			    	          ...
			    	          //+ "<a href=\"http://"+ipadd+":8090/EBwn2/updatemobno.html\"><input type=\"button\" value=\"Return\"></a>"
			    	          + "<form id=\"form80\" method=\"POST\" action=\"SchUtil\">"
			    	          ...
			    	          //+ "<a href=\"http://"+ipadd+":8090/EBwn2/updatepassword.html\"><input type=\"button\" value=\"Return\"></a>"
			    	          + "<form id=\"form80\" method=\"POST\" action=\"SchUtil\">"
