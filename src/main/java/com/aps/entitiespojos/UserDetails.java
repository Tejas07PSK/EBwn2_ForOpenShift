...
public class UserDetails implements Serializable
{
	 ...
	 private Address ad;
               ...
               @Column (name="FIRST_NAME",length=5000,nullable=false)
               private String firstname;
	 
               @Column (name="LAST_NAME",length=5000,nullable=false)
               private String lastname;
           
	 @Column (name="EMAIL_ID",length=5000,unique=true,nullable=false)
