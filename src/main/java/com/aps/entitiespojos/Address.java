...
public class Address implements Serializable
{
       ...
       private static final long serialVersionUID = 1L;
           ...
           @Column(name="LOCALITY",length=5000,nullable=false) 
            private String locality;
		   
           @Column(name="CITY",length=5000,nullable=false)
            private String city;
                              
           @Column(name="PINCODE",length=10,nullable=false)
           private String pincode;
                              
           @Column(name="STE",length=5000,nullable=false)
           private String state;
                              
           @Column(name="COUNTRY",length=5000,nullable=false)
